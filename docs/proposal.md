...
- 本文を編集するときの基本フォントサイズを変更できる
- アプリのカラーモードを、システム設定に従う、ライト、ダークから選べる
- 新規文書のデフォルトのファイルタイプを、Markdown（`.md`）、Markdown（`.markdown`）、Plain Text（`.txt`）から選べる
- 設定したフォントサイズ、カラーモード、デフォルトのファイルタイプがアプリの再起動後も維持される
...
- 文字コードや改行コードの選択
- 印刷やPDFへの出力
- 基本フォントサイズとカラーモードを超える、テーマやフォントの詳細なカスタマイズ
